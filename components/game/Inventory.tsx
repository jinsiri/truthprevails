  ...
  return (
    <section className={'relative'}>
      ...
      <button
        ...
        className='hover:bg-elevated inline-flex h-[40px] w-[40px] cursor-pointer items-center justify-center rounded-sm bg-yellow-600 p-2 text-white transition dark:bg-yellow-200 dark:text-black'
