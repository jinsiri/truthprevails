...
export function MasteredSkills() {
  return (
    <section className='absolute top-20 right-4 z-50 w-64 rounded-sm border-4 border-amber-900 bg-orange-50 p-6 shadow-[4px_4px_0px_rgba(0,0,0,0.2)] md:right-6'>
...
export function CharacterStatus() {
  return (
    <section className='absolute top-105 right-4 z-50 w-64 rounded-sm border-4 border-amber-900 bg-orange-50 p-6 shadow-[4px_4px_0px_rgba(0,0,0,0.2)] md:right-6'>
      <h3 className='mb-6 flex items-center gap-2 border-b-2 border-amber-200 pb-2 text-lg font-black text-amber-950 uppercase'>
