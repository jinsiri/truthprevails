...
export default function ClassicContact() {
  return (
    <section className={'relative h-screen bg-purple-200'}>
      ...
      <div className={'flex h-3/4 items-center text-2xl font-medium md:text-2xl lg:pl-120 lg:text-3xl xl:text-5xl'}>
        <Image className={'absolute bottom-0 -left-40'} src={`/images/search.png`} alt={'How to contact jinsil'} width={550} height={550} />
