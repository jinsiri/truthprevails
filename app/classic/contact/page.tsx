...
export default function ClassicContact() {
  return (
    <section className={'relative min-h-screen bg-purple-200 px-6 lg:px-0 xl:h-screen xl:overflow-hidden'}>
      <h2 className={'text-center text-2xl font-black uppercase md:text-5xl lg:text-7xl'}>Contact</h2>
      <div className={'my-10 items-center text-base font-medium md:my-20 md:text-2xl lg:flex lg:h-3/4 lg:pl-[25%] lg:text-3xl xl:my-0 xl:text-4xl'}>
        <ul className={'space-y-2 rounded-xl border-4 bg-gray-50/50 p-4 md:space-y-6 md:p-10'}>
      ...
      <motion.div
        className={'-bottom-20 -left-40 max-w-1/2 lg:max-w-1/3 xl:absolute xl:-bottom-40'}
      ...
      <motion.div
        className={'top-40 right-0 hidden h-3/4 flex-col items-center rounded-tl-xl bg-purple-100 px-10 py-14 text-center md:flex xl:absolute xl:max-w-1/3'}
