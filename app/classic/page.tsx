  ...
  return (
    <>
      <section className='home group overflow-hidden'>
        <div className='relative flex h-screen w-full items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-[length:200%] bg-[position:left] transition-[background-position] duration-1000 group-hover:bg-[position:right] dark:from-purple-200 dark:via-pink-200 dark:to-red-500'>
